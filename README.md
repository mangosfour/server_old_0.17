...
<a href='https://travis-ci.org/mangosfour/server/builds' target='MangosFour'><img src='https://travis-ci.org/mangosfour/server.png' border=0></a>
 Windows 
<a href='https://ci.appveyor.com/project/MaNGOS/server/history' target='MangosFour'><img src='https://ci.appveyor.com/api/projects/status/github/mangosfour/server?branch=master&svg=true' border=0></a>
</td></tr></table>

Mists of Pandaria WOW BRANCH
===========
### A World of Warcraft server for the wow expansion Mists of Pandaria
----
...
Mists of Pandaria version supporting clients from the [patch 5.4.1][50] branch, 
specifically patch 5.4.1.17538

If you liked the fifth incarnation of [World of Warcraft][2] and still want to play
[mop WoW][5], this is the branch for you. We provide an authentication
...
[5]: http://www.wowpedia.org/Patch_5.2.4 "WoW Mists of Pandaria· Patch 5.2.4 release notes"

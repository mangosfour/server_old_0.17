...
enum Opcodes
{
	...
	CMSG_AUTH_SESSION                                     = 0x09F1, // 5.3.0 17128
	...
	CMSG_CHAR_CREATE                                      = 0x0404, // 5.3.0 17128
	CMSG_CHAR_CUSTOMIZE                                   = 0x2C34, // 4.3.4 15595
	CMSG_CHAR_DELETE                                      = 0x010C, // 5.3.0 17128
	CMSG_CHAR_ENUM                                        = 0x0B1D, // 5.3.0 17128
	...
	CMSG_GAMEOBJECT_QUERY                                 = 0x058F, // 5.3.0 17128
	...
	CMSG_LEARN_TALENT									  = 0x2002, // 5.3.0 17128
	...
	CMSG_LOGOUT_REQUEST                                   = 0x1150, // 5.3.0 17128
	...
	CMSG_MESSAGECHAT_SAY								  = 0x016A, // 5.3.0 17128
	CMSG_MESSAGECHAT_WHISPER							  = 0x143A, // 5.3.0 17128
	CMSG_MESSAGECHAT_YELL								  = 0x1333, // 5.3.0 17128
	...
	CMSG_MOVE_FALL_LAND									  = 0x0CCF, // 5.3.0 17128
	CMSG_MOVE_FALL_RESET								  = 0x0AC3, // 5.3.0 17128
	...
	CMSG_MOVE_SET_RUN_MODE								  = 0x081F, // 5.3.0 17128
    CMSG_MOVE_SET_RUN_SPEED                               = 0x13AC,
	CMSG_MOVE_SET_WALK_MODE								  = 0x0856, // 5.3.0 17128
    CMSG_MOVE_SPLINE_DONE                                 = 0x790E, // 4.3.4 15595
	CMSG_MOVE_START_ASCEND								  = 0x089F, // 5.3.0 17128
	CMSG_MOVE_START_BACKWARD							  = 0x08D2, // 5.3.0 17128
	CMSG_MOVE_START_DESCEND								  = 0x0893, // 5.3.0 17128
	CMSG_MOVE_START_FORWARD								  = 0x0A4B, // 5.3.0 17128
	CMSG_MOVE_START_PITCH_DOWN							  = 0x0A12, // 5.3.0 17128
	CMSG_MOVE_START_PITCH_UP							  = 0x0C02, // 5.3.0 17128
	CMSG_MOVE_START_STRAFE_LEFT							  = 0x0816, // 5.3.0 17128
	CMSG_MOVE_START_STRAFE_RIGHT						  = 0x0843, // 5.3.0 17128
	CMSG_MOVE_START_SWIM								  = 0x0C13, // 5.3.0 17128
    CMSG_MOVE_START_SWIM_CHEAT                            = 0x12D9,
	CMSG_MOVE_START_TURN_LEFT							  = 0x0A9E, // 5.3.0 17128
	CMSG_MOVE_START_TURN_RIGHT							  = 0x0A07, // 5.3.0 17128
	CMSG_MOVE_STOP										  = 0x0813, // 5.3.0 17128
	CMSG_MOVE_STOP_ASCEND								  = 0x0A47, // 5.3.0 17128
	CMSG_MOVE_STOP_PITCH								  = 0x0AC7, // 5.3.0 17128
	CMSG_MOVE_STOP_STRAFE								  = 0x0A4A, // 5.3.0 17128
	CMSG_MOVE_STOP_SWIM									  = 0x0C93, // 5.3.0 17128
    CMSG_MOVE_STOP_SWIM_CHEAT                             = 0x12DA,
	CMSG_MOVE_STOP_TURN									  = 0x080A, // 5.3.0 17128
	...
	CMSG_READY_FOR_ACCOUNT_DATA_TIMES					  = 0x0755, // 5.3.0 17128
	CMSG_REALM_SPLIT									  = 0x0B48, // 5.3.0 17128
	...
	CMSG_SET_ACTION_BUTTON								  = 0x0400, // 5.3.0 17128
	...
	CMSG_SET_SELECTION									  = 0x1759, // 5.3.0 17128
	...
	MSG_MOVE_HEARTBEAT								      = 0x0E0B, // 5.3.0 17128
	...
	SMSG_ACCOUNT_DATA_TIMES								  = 0x0CD1, // 5.3.0 17128
	...
	SMSG_ADDON_INFO										  = 0x0C80, // 5.3.0 17128
	...
	SMSG_AUTH_CHALLENGE                                   = 0x0221, // 5.3.0 17128
	SMSG_AUTH_RESPONSE                                    = 0x0890, // 5.3.0 17128
	...
	SMSG_CHAR_CREATE                                      = 0x1495, // 5.3.0 17128
    SMSG_CHAR_CUSTOMIZE                                   = 0x4F16, // 4.3.4 15595
	SMSG_CHAR_DELETE                                      = 0x14C1, // 5.3.0 17128
	SMSG_CHAR_ENUM                                        = 0x0FDD, // 5.3.0 17128
	...
	SMSG_CLIENTCACHE_VERSION							  = 0x1489, // 5.3.0 17128
	...
	SMSG_CREATURE_QUERY_RESPONSE						  = 0x06D8, // 5.3.0 17128
	...
	SMSG_DESTROY_OBJECT									  = 0x04D1, // 5.3.0 17128
	...
	SMSG_GAMEOBJECT_QUERY_RESPONSE						  = 0x0290, // 5.3.0 17128
	...
	SMSG_MOVE_SET_WALK_SPEED							  = 0x051D, // 5.3.0 17128
	...
	SMSG_NEW_WORLD                                        = 0x04D9, // 5.3.0 17128
	...
	SMSG_REALM_SPLIT									  = 0x0F89, // 5.3.0 17128
	...
	SMSG_TRANSFER_PENDING								  = 0x13CD, // 5.3.0 17128
	...
	SMSG_TUTORIAL_FLAGS									  = 0x0D7E, // 5.3.0 17128
	...
	SMSG_UPDATE_OBJECT									  = 0x0C65, // 5.3.0 17128

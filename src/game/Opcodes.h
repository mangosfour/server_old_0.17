...
enum Opcodes
{
    ...
    SMSG_MOVE_SET_RUN_SPEED                               = 0x0758, // 5.3.0
    ...
    SMSG_MOVE_SET_SWIM_SPEED                              = 0x0905, // 5.3.0
    ...
    SMSG_TRADE_STATUS                                     = 0x0DC0, // 5.3.0
    ...
    SMSG_BATTLEFIELD_PORT_DENIED                          = 0x0F90, // 5.3.0
    ...
    SMSG_MOUNTRESULT                                      = 0x15D0, // 5.3.0
    SMSG_DISMOUNTRESULT                                   = 0x0CC5, // 5.3.0
    ...
    SMSG_PLAY_SPELL_VISUAL                                = 0x07D0, // 5.3.0
    ...
    SMSG_BATTLEFIELD_LIST                                 = 0x0ACC, // 5.3.0
    ...
    SMSG_BATTLEFIELD_STATUS_ACTIVE                        = 0x0CD8, // 5.3.0
    SMSG_BATTLEFIELD_STATUS_FAILED                        = 0x0798, // 5.3.0
    SMSG_BATTLEFIELD_STATUS_QUEUED                        = 0x11D1, // 5.3.0
    SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION              = 0x09D5, // 5.3.0
    SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS                 = 0x0BDC, // 5.3.0
    CMSG_BATTLEFIELD_PORT                                 = 0x711A, // 4.3.4 15595
    CMSG_INSPECT_HONOR_STATS                              = 0x791E, // 4.3.4 15595
    SMSG_INSPECT_HONOR_STATS                              = 0x109C, // 5.3.0
    ...
    SMSG_PVP_LOG_DATA                                     = 0x0795, // 5.3.0
    ...
    SMSG_BATTLEGROUND_PLAYER_JOINED                       = 0x1281, // 5.3.0
    SMSG_BATTLEGROUND_PLAYER_LEFT                         = 0x1581, // 5.3.0
    ...
    SMSG_MOVE_SET_CAN_FLY                                 = 0x0F48, // 5.3.0
    SMSG_MOVE_UNSET_CAN_FLY                               = 0x034D, // 5.3.0
    ...
    SMSG_ARENA_TEAM_COMMAND_RESULT                        = 0x06C1, // 5.3.0
    ...
    SMSG_MOVE_SET_FLIGHT_SPEED                            = 0x0E54, // 5.3.0
    ...
    SMSG_TIME_SYNC_REQ                                    = 0x0AD4, // 5.3.0
    ...
    SMSG_GROUPACTION_THROTTLED                            = 0x1394, // 5.3.0
    ...
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS                     = 0x0DD1, // 5.3.0
    ...
    SMSG_ALL_ACHIEVEMENT_DATA                             = 0x12D1, // 5.3.0
    ...
    SMSG_BATTLEGROUND_INFO_THROTTLED                      = 0x0D9D, // 5.3.0

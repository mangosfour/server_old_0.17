...
enum Opcodes
{
    ...
    CMSG_DESTROY_ITEM                                     = 0x16CF,
    CMSG_DESTROYMONSTER                                   = 0x1013,
    CMSG_DISABLE_PVP_CHEAT                                = 0x1031,
    CMSG_DISMISS_CONTROLLED_VEHICLE                       = 0x1261,
    ...
    CMSG_MESSAGECHAT_ADDON_INSTANCE                       = 0x05D3,
    ...
    SMSG_CHANGEPLAYER_DIFFICULTY_RESULT                   = 0x2217,

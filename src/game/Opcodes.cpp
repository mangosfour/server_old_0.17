...
void InitializeOpcodes()
{
	...
	OPCODE(CMSG_CHALLENGE_MODE_REQUEST_LEADERS,          STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	//OPCODE(CMSG_CHALLENGE_MODE_REQUEST_MAP_STATS,        STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    ...
    //OPCODE(CMSG_REALM_QUERY,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleRealmQueryOpcode          );
    OPCODE(SMSG_REALM_QUERY_RESPONSE,                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE,           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
	OPCODE(SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD,          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
	//OPCODE(SMSG_CHALLENGE_MODE_START,                      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
	//OPCODE(SMSG_CHALLENGE_MODE_RESET,                      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
	OPCODE(SMSG_CHALLENGE_MODE_REWARDS,                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
	...
	OPCODE(SMSG_BATTLENET_CHALLENGE_ABORT,                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	OPCODE(SMSG_BATTLENET_CHALLENGE_START,                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(SMSG_CANCEL_ORPHAN_SPELL_VISUAL,                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	OPCODE(SMSG_CANCEL_SCENE,                              STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	OPCODE(SMSG_CAN_DUEL_RESULT,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(CMSG_DUEL_PROPOSED,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	OPCODE(CMSG_DUEL_RESPONSE,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    ...
    //OPCODE(SMSG_GAMEOBJECT_DESPAWN_ANIM,                 STATUS_NEVER,    PROCESS_INPLACE,     s &WorldSession::Handle_ServerSide               );
	...
	OPCODE(CMSG_CHAT_ADDON_MESSAGE_CHANNEL,                STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	OPCODE(CMSG_CHAT_ADDON_MESSAGE_INSTANCE_CHAT,          STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	OPCODE(CMSG_CHAT_UNREGISTER_ADDON_PREFIXES,            STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	OPCODE(CMSG_CHAT_UNREGISTER_ALL_ADDON_PREFIXES,        STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	...
	//OPCODE(CMSG_AUTOSTORE_BANK_RAEGENT,                    STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
	...
	OPCODE(SMSG_CHAT_SERVER_DISCONNECTED,                  STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	OPCODE(SMSG_CHAT_SERVER_RECONNECTED,                   STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	OPCODE(SMSG_CHAT_DOWN,                                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	OPCODE(SMSG_CHAT_IGNORED_ACCOUNT_MUTED,                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(CMSG_BATTLE_CHAR_BOOST,                         STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(SMSG_BATTLE_CHAR_BOOST_ITEMS,                   STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE,            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_ACTION,                         STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(CMSG_BATTLE_PET_SET_FLAGS,                      STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_DELETE_PET,                     STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_INITIAL_UPDATE_RESPONSE,        STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_MODIFY_NAME,                    STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_QUERY_NAME,                     STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_REQUEST_JOURNAL,                STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_SUMMON_COMPANION,               STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_ROUND,                          STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,               STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(CMSG_BATTLE_PET_SET_BATTLE_SLOT,                STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                    );
	OPCODE(SMSG_BATTLE_PET_DELETED,                        STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_JOURNAL,                        STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED,          STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED,            STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_QUERY_NAME_RESPONSE,            STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_SLOT_UPDATE,                    STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_UPDATE,                         STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_CAGE_DATE_ERROR,                STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_ERROR,                          STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_HEALED,                         STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_LICENSE_CHANGED,                STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_CHAT_RESTRICTED,                STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_DEBUG_QUEUE_DUMP_RESPONSE,      STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_FINAL_ROUND,                    STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_FINALIZE_LOCATION,              STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_FINISHED,                       STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_FIRST_ROUND,                    STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_MAX_GAME_LENGHT_WARRNING,       STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_PVP_CHALLENGE,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_QUEUE_PROPOSE_MATCH,            STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_QUEUE_STATUS,                   STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_REPLACEMENTS_MADE,              STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_REQUEST_FAILED,                 STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_SCENE_OBJECT_FINAL_ROUND,       STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_SCENE_OBJECT_FIRST_ROUND,       STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_SCENE_OBJECT_FULL_UPDATE,       STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_SCENE_OBJECT_REPLACEMENTS_MADE, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_RESTORED,                       STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_REVOKED,                        STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	OPCODE(SMSG_BATTLE_PET_TRAP_LEVEL,                     STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide              );
	...
	//OPCODE(SMSG_ARENA_SEASON_WORLD_STATE,                  STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               );
	...
	//OPCODE(SMSG_ARENA_TRIGGER_DENIED,                    STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	//OPCODE(SMSG_ARENA_TRIGGER_MESSAGE,                   STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	//OPCODE(SMSG_ARENA_TRIGGER_MOVEMENT_UPDATE,           STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	...
	OPCODE(CMSG_CHEAT_RESET_FACTION,                       STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	...
	//OPCODE(CMSG_COMMENTATOR_GET_PARTY_INFO,                STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
	...
	OPCODE(SMSG_CALENDAR_EVENT_INVITE_STATUS,            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(SMSG_CALENDAR_EVENT_MODERATOR_STATUS,         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(SMSG_CALENDAR_EVENT_INITIAL_INVITE,           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                     );
	...
	OPCODE(SMSG_AURA_POINTS_DEPLETED,                      STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               );
	...
	//OPCODE(SMSG_AVERAGE_ITEM_LEVEL_INFORM,               STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide                );
	...
	OPCODE(CMSG_CONFIRM_RESPEC_WIPE,                       STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    ...
    OPCODE(SMSG_BATTLEFIELD_MANAGER_STATE_CHANGE,          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(MSG_VERIFY_CONNECTIVITY,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	OPCODE(CMSG_CLEAR_RAID_MARKER,                         STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //OPCODE(CMSG_CLEAR_HOLIDAY_BG_WIN_TIME,               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //OPCODE(SKIRMISH_QUEUE_COMMAND,      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
